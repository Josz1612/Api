...
<body>
    <div class="container">
        ...
        <!-- 🔒 PANEL DE SEGURIDAD - Muestra implementaciones de Semana 8 y 9 -->
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 15px; margin: 30px 0; color: white; box-shadow: 0 8px 32px rgba(102, 126, 234, 0.3);">
            <h2 style="margin-top: 0; text-align: center; font-size: 2em;">🔒 Sistema de Seguridad Implementado</h2>
            <p style="text-align: center; opacity: 0.95; font-size: 1.1em;">Hito 2: Autenticación JWT + HTTPS/TLS + Gestión de Secretos</p>
            
            <div class="feature-grid" style="margin-top: 25px;">
                <div class="feature-card" style="background: rgba(255,255,255,0.95); color: #2d3748;">
                    <h3>🎫 JWT Authentication</h3>
                    <p><strong>✅ Semana 8 Completada</strong></p>
                    <ul style="text-align: left; margin: 10px 0;">
                        <li>🔐 Tokens firmados con HS256</li>
                        <li>👥 Roles: admin, vendedor, cliente</li>
                        <li>🔄 Refresh tokens (7 días)</li>
                        <li>🚪 Logout con revocación</li>
                        <li>✅ 30 tests automatizados</li>
                    </ul>
                    <a href="/login" class="btn" style="margin-top: 10px; background: #667eea;">🔑 Probar Login</a>
                </div>
                
                <div class="feature-card" style="background: rgba(255,255,255,0.95); color: #2d3748;">
                    <h3>🔒 HTTPS/TLS Encryption</h3>
                    <p><strong>✅ Semana 9 Completada</strong></p>
                    <ul style="text-align: left; margin: 10px 0;">
                        <li>🔐 Certificados SSL/TLS</li>
                        <li>🌐 Puerto seguro 8443</li>
                        <li>🔄 Redirección HTTP→HTTPS</li>
                        <li>📜 RSA 4096 bits</li>
                        <li>✅ Conexión cifrada E2E</li>
                    </ul>
                    <div id="https-status" style="margin-top: 10px; padding: 10px; background: #48bb78; border-radius: 8px; font-weight: bold;">
                ...
                <div class="feature-card" style="background: rgba(255,255,255,0.95); color: #2d3748;">
                    ...
                    <ul style="text-align: left; margin: 10px 0;">
                        ...
                        <li>🚫 Sin hardcode en Git</li>
                        <li>✅ Validación automática</li>
                        <li>🔄 Rotación de claves</li>
                    </ul>
                    <code style="display: block; margin-top: 10px; padding: 10px; background: #2d3748; color: #48bb78; border-radius: 8px; font-size: 0.9em;">
                        JWT_SECRET: ✓ Cargado desde .env
                    </code>
                </div>
            </div>
            
            <div style="text-align: center; margin-top: 25px; padding: 20px; background: rgba(255,255,255,0.1); border-radius: 10px;">
                <h4 style="margin-top: 0;">📊 Estado del Sistema</h4>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 15px; margin-top: 15px;">
                    <div style="background: rgba(255,255,255,0.2); padding: 15px; border-radius: 8px;">
                        <div style="font-size: 2em;">✅</div>
                        <div style="font-size: 0.9em; margin-top: 5px;">Autenticación</div>
                    </div>
                    <div style="background: rgba(255,255,255,0.2); padding: 15px; border-radius: 8px;">
                        <div style="font-size: 2em;">🔒</div>
                        <div style="font-size: 0.9em; margin-top: 5px;">Cifrado TLS</div>
                    </div>
                    <div style="background: rgba(255,255,255,0.2); padding: 15px; border-radius: 8px;">
                        <div style="font-size: 2em;">🔑</div>
                        <div style="font-size: 0.9em; margin-top: 5px;">Secretos</div>
                    </div>
                    <div style="background: rgba(255,255,255,0.2); padding: 15px; border-radius: 8px;">
                        <div style="font-size: 2em;">✅</div>
                        <div style="font-size: 0.9em; margin-top: 5px;">Tests (30)</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="text-align: center; margin-top: 40px; padding: 20px; background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%); border-radius: 15px;">
            ...
            <div style="display: flex; gap: 15px; justify-content: center; margin-top: 20px; flex-wrap: wrap;">
                <a href="/docs" class="btn">🚀 Documentación API</a>
                <a href="/jwt-demo" class="btn" style="background: linear-gradient(135deg, #f6ad55 0%, #ed8936 100%);">
                    🔒 Demo Interactiva JWT + HTTPS
                </a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {{
            ...
            if (isSecure) {{
                httpsStatus.innerHTML = '🔒 Conexión HTTPS Activa (Puerto 8443)';
                httpsStatus.style.background = '#48bb78';
            }} else {{
                httpsStatus.innerHTML = '⚠️ Conexión HTTP - Cambiar a HTTPS';
                httpsStatus.style.background = '#f6ad55';
            }}
            ...
            if (isSecure && window.crypto && window.crypto.subtle) {{
                ...
                certInfo.style.marginTop = '10px';
                certInfo.style.fontSize = '0.85em';
                certInfo.style.opacity = '0.9';
                certInfo.innerHTML = '🔐 TLS 1.3 · RSA 4096 bits · Certificado válido';
                httpsStatus.appendChild(certInfo);
            }}
        }});
    </script>
</body>
...
<body>
    <div class="container">
        ...
        <!-- ⭐ BOTÓN CREAR PRODUCTO - SÚPER VISIBLE -->
        <div style="text-align: center; margin: 30px 0; padding: 20px; background: linear-gradient(135deg, #ff6b6b 0%, #ee5a6f 100%); border-radius: 15px; box-shadow: 0 8px 20px rgba(0,0,0,0.2);">
            <button onclick="openProductModal()" style="background: white; color: #ee5a6f; padding: 20px 50px; border: none; border-radius: 12px; font-size: 24px; font-weight: bold; cursor: pointer; box-shadow: 0 4px 15px rgba(0,0,0,0.3); transition: all 0.3s;">
                🔐 CREAR PRODUCTO CON JWT
            </button>
            <p style="color: white; margin-top: 15px; font-size: 14px;">Prueba crear productos con diferentes roles (admin, vendedor, cliente)</p>
        </div>
        ...
        <div class="nav-buttons">
            ...
            <button class="btn" onclick="openProductModal()" style="background: red !important; color: white !important; font-size: 20px !important; font-weight: bold !important; padding: 15px 30px !important; border: 5px solid yellow !important;">🔐🔐🔐 CREAR PRODUCTO 🔐🔐🔐</button>
        ...
        <!-- 🔐 Panel de Agregar Producto (Requiere JWT) - DESPUÉS DE LOS PRODUCTOS -->
        <div class="admin-panel" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 25px; border-radius: 15px; margin: 30px 0; border: 3px solid #667eea; color: white; box-shadow: 0 10px 30px rgba(102, 126, 234, 0.3);">
            <h2 style="margin: 0 0 15px 0; font-size: 1.8em;">🔐 Agregar Nuevo Producto</h2>
            <div style="background: rgba(255,255,255,0.15); padding: 15px; border-radius: 10px; margin-bottom: 20px;">
                <p style="margin: 0; font-size: 1.1em; font-weight: 600;">⚠️ PRUEBA DE SEGURIDAD JWT</p>
                <p style="margin: 5px 0 0 0; font-size: 0.95em; opacity: 0.95;">
                    Intenta agregar un producto con diferentes roles para ver el control de acceso en acción
                </p>
            </div>
            
            <div id="auth-section" style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 10px; margin-bottom: 20px;">
                <h3 style="margin: 0 0 15px 0; font-size: 1.2em;">Paso 1: Autenticación</h3>
                <div style="display: flex; gap: 10px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
                    <select id="admin-user-select" style="flex: 1; min-width: 250px; padding: 12px; border: 2px solid #667eea; border-radius: 8px; font-size: 15px; font-weight: 600;">
                        <option value='{{\"email\":\"admin@ecomarket.com\",\"password\":\"admin123\"}}'>🔑 Admin → ✅ SÍ puede crear productos</option>
                        <option value='{{\"email\":\"vendedor@ecomarket.com\",\"password\":\"vendedor123\"}}'>🛍️ Vendedor → ✅ SÍ puede crear productos</option>
                        <option value='{{\"email\":\"cliente@ecomarket.com\",\"password\":\"cliente123\"}}'>👤 Cliente → ❌ NO puede crear (Verás error 403)</option>
                    </select>
                    <button onclick="loginAdmin()" style="padding: 12px 25px; background: #48bb78; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: bold; font-size: 15px; box-shadow: 0 4px 15px rgba(72, 187, 120, 0.4);">
                        🚀 Hacer Login
                    </button>
                </div>
                <div id="token-status" style="font-size: 0.9em; padding: 12px; background: rgba(255,255,255,0.15); border-radius: 8px; display: none;">
                    <div><strong>🎫 Token JWT:</strong> <span id="token-preview" style="font-family: monospace;"></span></div>
                    <div style="margin-top: 5px;"><strong>👤 Rol:</strong> <span id="user-role" style="text-transform: uppercase; font-weight: 700;"></span></div>
                </div>
            </div>
            
            <div id="product-form" style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 10px; opacity: 0.4; pointer-events: none;">
                <h3 style="margin: 0 0 15px 0; font-size: 1.2em;">Paso 2: Datos del Producto</h3>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
                    <input type="text" id="new-product-name" placeholder="Nombre del producto" value="Producto Demo Cliente" style="padding: 12px; border: 2px solid #667eea; border-radius: 8px; font-size: 14px;">
                    <input type="text" id="new-product-category" placeholder="Categoría" value="Prueba Seguridad" style="padding: 12px; border: 2px solid #667eea; border-radius: 8px; font-size: 14px;">
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
                    <input type="number" id="new-product-price" placeholder="Precio" value="50.00" step="0.01" style="padding: 12px; border: 2px solid #667eea; border-radius: 8px; font-size: 14px;">
                    <input type="number" id="new-product-stock" placeholder="Stock" value="5" style="padding: 12px; border: 2px solid #667eea; border-radius: 8px; font-size: 14px;">
                </div>
                <input type="text" id="new-product-desc" placeholder="Descripción" value="Test de autenticación JWT" style="width: 100%; padding: 12px; border: 2px solid #667eea; border-radius: 8px; margin-bottom: 12px; font-size: 14px;">
                <div style="display: flex; gap: 15px; margin-bottom: 15px; font-size: 15px;">
                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                        <input type="checkbox" id="new-product-organic" style="width: 18px; height: 18px;"> 🌱 Orgánico
                    </label>
                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                        <input type="checkbox" id="new-product-available" checked style="width: 18px; height: 18px;"> ✅ Disponible
                    </label>
                </div>
                <button id="add-product-btn" onclick="addNewProduct()" style="width: 100%; padding: 15px; background: #48bb78; color: white; border: none; border-radius: 10px; cursor: pointer; font-weight: bold; font-size: 17px; box-shadow: 0 4px 15px rgba(72, 187, 120, 0.4);" disabled>
                    🔒 Primero debes hacer Login arriba
                </button>
                <div id="add-product-response" style="margin-top: 15px; display: none;"></div>
            </div>
        </div>
        
        <!-- 🔐 Modal para Crear Producto -->
        <div id="productModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.7); z-index: 1000; overflow-y: auto;">
            <div style="max-width: 600px; margin: 50px auto; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 15px; color: white; position: relative;">
                <button onclick="closeProductModal()" style="position: absolute; top: 15px; right: 15px; background: rgba(255,255,255,0.2); border: none; color: white; font-size: 24px; width: 40px; height: 40px; border-radius: 50%; cursor: pointer; font-weight: bold;">×</button>
                
                <h2 style="margin: 0 0 20px 0; font-size: 2em;">🔐 Crear Nuevo Producto</h2>
                <div style="background: rgba(255,255,255,0.15); padding: 15px; border-radius: 10px; margin-bottom: 20px;">
                    <p style="margin: 0; font-size: 1.1em; font-weight: 600;">⚠️ PRUEBA DE SEGURIDAD JWT</p>
                    <p style="margin: 5px 0 0 0; font-size: 0.95em;">Este endpoint requiere autenticación y permisos de admin/vendedor</p>
                </div>
                
                <div style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 10px; margin-bottom: 20px;">
                    <h3 style="margin: 0 0 15px 0;">Paso 1: Autenticación</h3>
                    <div style="display: flex; gap: 10px; margin-bottom: 15px; flex-wrap: wrap;">
                        <select id="modal-user-select" style="flex: 1; min-width: 200px; padding: 12px; border: 2px solid #667eea; border-radius: 8px; font-size: 14px; font-weight: 600;">
                            <option value='{{\"email\":\"admin@ecomarket.com\",\"password\":\"admin123\"}}'>🔑 Admin → ✅ Puede crear</option>
                            <option value='{{\"email\":\"vendedor@ecomarket.com\",\"password\":\"vendedor123\"}}'>🛍️ Vendedor → ✅ Puede crear</option>
                            <option value='{{\"email\":\"cliente@ecomarket.com\",\"password\":\"cliente123\"}}'>👤 Cliente → ❌ Error 403</option>
                        </select>
                        <button onclick="modalLogin()" style="padding: 12px 20px; background: #48bb78; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: bold; box-shadow: 0 4px 15px rgba(72, 187, 120, 0.4);">
                            🚀 Login
                        </button>
                    </div>
                    <div id="modal-token-status" style="display: none; padding: 10px; background: rgba(255,255,255,0.15); border-radius: 8px; font-size: 0.9em;">
                        <div><strong>🎫 Token:</strong> <span id="modal-token-preview" style="font-family: monospace; font-size: 0.85em;"></span></div>
                        <div style="margin-top: 5px;"><strong>👤 Rol:</strong> <span id="modal-user-role" style="text-transform: uppercase; font-weight: 700;"></span></div>
                    </div>
                </div>
                
                <div id="modal-product-form" style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 10px; opacity: 0.4; pointer-events: none;">
                    <h3 style="margin: 0 0 15px 0;">Paso 2: Datos del Producto</h3>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 10px;">
                        <input type="text" id="modal-product-name" placeholder="Nombre" value="Test Cliente" style="padding: 10px; border: 2px solid #667eea; border-radius: 8px;">
                        <input type="text" id="modal-product-category" placeholder="Categoría" value="Seguridad" style="padding: 10px; border: 2px solid #667eea; border-radius: 8px;">
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 10px;">
                        <input type="number" id="modal-product-price" placeholder="Precio" value="25.00" step="0.01" style="padding: 10px; border: 2px solid #667eea; border-radius: 8px;">
                        <input type="number" id="modal-product-stock" placeholder="Stock" value="3" style="padding: 10px; border: 2px solid #667eea; border-radius: 8px;">
                    </div>
                    <input type="text" id="modal-product-desc" placeholder="Descripción" value="Prueba de JWT" style="width: 100%; padding: 10px; border: 2px solid #667eea; border-radius: 8px; margin-bottom: 10px;">
                    <div style="display: flex; gap: 10px; margin-bottom: 15px;">
                        <label style="display: flex; align-items: center; gap: 5px;"><input type="checkbox" id="modal-product-organic"> 🌱 Orgánico</label>
                        <label style="display: flex; align-items: center; gap: 5px;"><input type="checkbox" id="modal-product-available" checked> ✅ Disponible</label>
                    </div>
                    <button id="modal-add-btn" onclick="modalAddProduct()" style="width: 100%; padding: 15px; background: #48bb78; color: white; border: none; border-radius: 10px; cursor: pointer; font-weight: bold; font-size: 16px;" disabled>
                        🔒 Primero haz Login
                    </button>
                    <div id="modal-response" style="margin-top: 15px; display: none;"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        let adminToken = null; // Token JWT para agregar productos

        // 🔐 Función para login de admin
        async function loginAdmin() {{
            const select = document.getElementById('admin-user-select');
            const credentials = JSON.parse(select.value);
            ...
            try {{
                ...
                if (response.ok) {{
                    ...
                    const shortToken = adminToken.substring(0, 40) + '...';
                    tokenPreview.textContent = shortToken;
                    userRole.textContent = data.user.role.toUpperCase();
                    tokenStatus.style.display = 'block';
                    tokenStatus.style.background = 'rgba(72, 187, 120, 0.3)';
                    
                    // Habilitar formulario SIEMPRE (para que cliente pueda intentar y ver el error)
                    ...
                    if (data.user.role === 'cliente') {{
                        addBtn.textContent = `⚠️ Intentar Agregar (Debería Fallar - Rol: ${{data.user.role}})`;
                        addBtn.style.background = '#f6ad55';
                    }} else {{
                        addBtn.textContent = `✅ Agregar Producto (Rol: ${{data.user.role}})`;
                        addBtn.style.background = '#48bb78';
                    }}
                    
                    alert(`✅ Login exitoso\\n\\nUsuario: ${{data.user.email}}\\nRol: ${{data.user.role}}\\n\\n${{
                        data.user.role === 'cliente' 
                        ? '⚠️ NOTA: Como CLIENTE, podrás hacer clic en "Agregar Producto" pero el servidor te dará error 403 Forbidden'
                        : '✅ Tienes permisos para crear productos'
                    }}`);
                }} else {{
                    alert('❌ Error en login: ' + data.detail);
                    adminToken = null;
                }}
            }} catch (error) {{
        ...
        // 🛍️ Función para agregar nuevo producto
        async function addNewProduct() {{
            if (!adminToken) {{
                alert('⚠️ Primero debes hacer login con un usuario autorizado');
                return;
            }}
            
            const responseDiv = document.getElementById('add-product-response');
            
            const productData = {{
                nombre: document.getElementById('new-product-name').value,
                categoria: document.getElementById('new-product-category').value,
                ...
                disponible: document.getElementById('new-product-available').checked,
                es_organico: document.getElementById('new-product-organic').checked,
                descripcion: document.getElementById('new-product-desc').value || ''
            }};
            ...
            try {{
                ...
                if (response.ok) {{
                    responseDiv.innerHTML = `
                        <div style="padding: 15px; background: rgba(72, 187, 120, 0.3); border-radius: 8px; border: 2px solid #48bb78;">
                            <div style="font-size: 1.2em; margin-bottom: 10px;"><strong>✅ ¡Producto creado exitosamente!</strong></div>
                            <div><strong>ID:</strong> ${{data.id}}</div>
                            <div><strong>Nombre:</strong> ${{data.nombre}}</div>
                            <div><strong>Precio:</strong> $${{data.precio}}</div>
                            <div style="margin-top: 10px; padding: 8px; background: rgba(255,255,255,0.5); border-radius: 6px;">
                                <small>✅ El usuario con rol <strong>${{data.role || 'autorizado'}}</strong> tiene permisos para crear productos</small>
                            </div>
                        </div>
                    `;
                    
                    // Limpiar formulario
                    document.getElementById('new-product-name').value = 'Producto Demo';
                    document.getElementById('new-product-category').value = 'Test';
                    document.getElementById('new-product-price').value = '99.99';
                    document.getElementById('new-product-stock').value = '10';
                    document.getElementById('new-product-desc').value = 'Prueba de seguridad JWT';
                    document.getElementById('new-product-organic').checked = false;
                    ...
                    // Detectar si es error 403 (Forbidden)
                    const is403 = response.status === 403;
                    
                    responseDiv.innerHTML = `
                        <div style="padding: 15px; background: rgba(229, 62, 62, 0.3); border-radius: 8px; border: 2px solid #e53e3e;">
                            <div style="font-size: 1.2em; margin-bottom: 10px;">
                                <strong>${{is403 ? '🚫 403 FORBIDDEN' : '❌ Error ' + response.status}}</strong>
                            </div>
                            <div style="margin-bottom: 10px;"><strong>Mensaje:</strong> ${{data.detail || JSON.stringify(data)}}</div>
                            ${{is403 ? `
                                <div style="margin-top: 15px; padding: 12px; background: rgba(255,255,255,0.9); color: #2d3748; border-radius: 6px; border-left: 4px solid #e53e3e;">
                                    <strong>🔒 Explicación de Seguridad:</strong><br>
                                    • El servidor validó el token JWT ✅<br>
                                    • El token es válido pero tu ROL no tiene permisos ❌<br>
                                    • Solo usuarios con rol <strong>admin</strong> o <strong>vendedor</strong> pueden crear productos<br>
                                    • Tu rol actual: <strong>cliente</strong><br><br>
                                    <strong>✅ La seguridad JWT funciona correctamente!</strong>
                                </div>
                            ` : ''}}
                        </div>
                    `;
                ...
                responseDiv.innerHTML = `
                    <div style="padding: 10px; background: rgba(229, 62, 62, 0.3); border-radius: 6px; border: 2px solid #e53e3e;">
        ...
        function closeProductModal() {{
            ...
            // Resetear formulario
            modalToken = null;
            document.getElementById('modal-token-status').style.display = 'none';
            document.getElementById('modal-product-form').style.opacity = '0.4';
            document.getElementById('modal-product-form').style.pointerEvents = 'none';
            document.getElementById('modal-add-btn').disabled = true;
            document.getElementById('modal-add-btn').textContent = '🔒 Primero haz Login';
            document.getElementById('modal-response').style.display = 'none';
        }}
        
        async function modalLogin() {{
            const select = document.getElementById('modal-user-select');
            const credentials = JSON.parse(select.value);
            const tokenStatus = document.getElementById('modal-token-status');
            const tokenPreview = document.getElementById('modal-token-preview');
            const userRole = document.getElementById('modal-user-role');
            ...
            try {{
                ...
                if (response.ok) {{
                    modalToken = data.access_token;
                    const shortToken = modalToken.substring(0, 35) + '...';
                    tokenPreview.textContent = shortToken;
                    userRole.textContent = data.user.role.toUpperCase();
                    tokenStatus.style.display = 'block';
                    tokenStatus.style.background = 'rgba(72, 187, 120, 0.3)';
                    
                    // Habilitar formulario SIEMPRE
                    productForm.style.opacity = '1';
                    productForm.style.pointerEvents = 'auto';
                    addBtn.disabled = false;
                    
                    if (data.user.role === 'cliente') {{
                        addBtn.textContent = `⚠️ Intentar Crear (Rol: ${{data.user.role}} - Verás error 403)`;
                        addBtn.style.background = '#f6ad55';
                    }} else {{
                        addBtn.textContent = `✅ Crear Producto (Rol: ${{data.user.role}})`;
                        addBtn.style.background = '#48bb78';
                    }}
                    
                    alert(`✅ Login exitoso\\n\\nUsuario: ${{data.user.email}}\\nRol: ${{data.user.role}}\\n\\n${{
                        data.user.role === 'cliente' 
                        ? '⚠️ Como CLIENTE verás error 403 al intentar crear el producto'
                        : '✅ Tienes permisos para crear productos'
                    }}`);
                }} else {{
        ...
        async function modalAddProduct() {{
            ...
            const productData = {{
                nombre: document.getElementById('modal-product-name').value,
                categoria: document.getElementById('modal-product-category').value,
                precio: parseFloat(document.getElementById('modal-product-price').value),
                stock: parseInt(document.getElementById('modal-product-stock').value),
                disponible: document.getElementById('modal-product-available').checked,
                es_organico: document.getElementById('modal-product-organic').checked,
                descripcion: document.getElementById('modal-product-desc').value
            }};
            ...
            try {{
                ...
                if (response.ok) {{
                    responseDiv.innerHTML = `
                        <div style="padding: 15px; background: rgba(72, 187, 120, 0.3); border-radius: 8px; border: 2px solid #48bb78;">
                            <div style="font-size: 1.2em; margin-bottom: 10px;"><strong>✅ ¡Producto creado!</strong></div>
                            <div><strong>ID:</strong> ${{data.id}}</div>
                            <div><strong>Nombre:</strong> ${{data.nombre}}</div>
                            <div><strong>Precio:</strong> $${{data.precio}}</div>
                        </div>
                    ...
                    responseDiv.innerHTML = `
                        <div style="padding: 15px; background: rgba(229, 62, 62, 0.3); border-radius: 8px; border: 2px solid #e53e3e;">
                            ...
                            <div style="margin-bottom: 10px;"><strong>Mensaje:</strong> ${{data.detail}}</div>
                            ${{is403 ? `
                                <div style="margin-top: 15px; padding: 15px; background: rgba(255,255,255,0.95); color: #2d3748; border-radius: 8px; border-left: 5px solid #e53e3e;">
                                    <div style="font-size: 1.1em; font-weight: bold; margin-bottom: 10px;">🔒 Explicación de Seguridad JWT:</div>
                                    <div style="margin: 8px 0;">✅ El servidor validó correctamente el token JWT</div>
                                    <div style="margin: 8px 0;">❌ Pero tu <strong>rol "cliente"</strong> NO tiene permisos suficientes</div>
                                    <div style="margin: 8px 0;">🔑 Solo roles <strong>admin</strong> o <strong>vendedor</strong> pueden crear productos</div>
                                    <div style="margin-top: 12px; padding: 10px; background: #48bb78; color: white; border-radius: 6px; text-align: center; font-weight: bold;">
                                        ✅ ¡La seguridad JWT funciona perfectamente!
                                    </div>
                                </div>
                            ` : ''}}
                        </div>
...
def get_jwt_demo_html():
    """🔒 Página de demostración interactiva de JWT + HTTPS"""
    return """<!DOCTYPE html>
<html lang="es">
<head>
    <title>🔒 Demo JWT + HTTPS - EcoMarket</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.9em' font-size='90'>🔒</text></svg>">
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🔒 Demostración Interactiva</h1>
            <p>Hito 2: JWT Authentication + HTTPS + Gestión de Secretos</p>
        </div>
        
        <div id="https-indicator" class="security-indicator">
            <span style="font-size: 2em;">🔒</span>
            <div>
                <div>Conexión Segura Activa</div>
                <div style="font-size: 0.9em; opacity: 0.9;">HTTPS en puerto 8443</div>
            </div>
        </div>
        
        <!-- PASO 1: LOGIN -->
        <div class="card">
            <h2>📝 Paso 1: Obtener Token JWT (Login)</h2>
            <div class="step">
                ...
                <div class="form-group">
                    ...
                    <select id="user-select">
                        <option value='{{\"email\":\"admin@ecomarket.com\",\"password\":\"admin123\"}}'>
                            🔑 Admin (Acceso completo)
                        </option>
                        <option value='{{\"email\":\"vendedor@ecomarket.com\",\"password\":\"vendedor123\"}}'>
                            🛍️ Vendedor (Crear y editar productos)
                        </option>
                        <option value='{{\"email\":\"cliente@ecomarket.com\",\"password\":\"cliente123\"}}'>
                            👤 Cliente (Solo lectura)
                        </option>
                    </select>
                </div>
                
                <button class="btn" onclick="login()">🚀 Hacer Login</button>
                
                <div id="login-response" style="display: none; margin-top: 15px;">
                    <div class="status status-success">✅ Login Exitoso</div>
                    <p style="margin-top: 10px; font-weight: 600;">Access Token:</p>
                    <div id="token-display" class="token-display"></div>
                    <p style="margin-top: 15px; font-weight: 600;">Información del Usuario:</p>
                    <div id="user-info" class="response-display"></div>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <ul>
                    <li>El servidor valida tus credenciales</li>
                    <li>Si son correctas, genera un JWT firmado con <code>JWT_SECRET</code> del .env</li>
                    <li>El token viaja cifrado por HTTPS (no puede ser interceptado)</li>
                    <li>El token expira en 30 minutos por seguridad</li>
                </ul>
            </div>
        </div>
        ...
        <!-- PASO 2: USAR TOKEN -->
        <div class="card">
            <h2>🔐 Paso 2: Usar Token en Endpoint Protegido</h2>
            <div class="step">
                <h3>🛍️ Crear Producto (Requiere Autenticación)</h3>
                
                <div class="form-group">
                    <label>Nombre del producto:</label>
                    <input type="text" id="product-name" value="Producto Demo Seguro" />
                </div>
                
                <div class="form-group">
                    <label>Categoría:</label>
                    <input type="text" id="product-category" value="Demostración" />
                </div>
                
                <div class="grid">
                    <div class="form-group">
                        <label>Precio:</label>
                        <input type="number" id="product-price" value="99.99" step="0.01" />
                    </div>
                    
                    <div class="form-group">
                        <label>Stock:</label>
                        <input type="number" id="product-stock" value="100" />
                    </div>
                </div>
                
                <div class="form-group">
                    <label>Descripción:</label>
                    <input type="text" id="product-desc" value="Creado en demo de seguridad" />
                </div>
                
                <button class="btn btn-success" id="create-btn" onclick="createProduct()" disabled>
                    🔒 Crear Producto (Requiere Token)
                </button>
                
                <div id="create-response" style="display: none; margin-top: 15px;"></div>
            </div>
            
            <div class="info-box">
                <h4>💡 Seguridad en acción:</h4>
                <ul>
                    <li>Este endpoint está protegido por JWT middleware</li>
                    <li>Sin token válido → 401 Unauthorized</li>
                    <li>Con token pero rol insuficiente → 403 Forbidden</li>
                    <li>El servidor verifica la firma del token con <code>JWT_SECRET</code></li>
                </ul>
            </div>
        </div>
        ...
        <div class="card">
            <h2>❌ Paso 3: Probar SIN Token (Debe Fallar)</h2>
            <div class="step">
                <h3>🚫 Intentar acceso sin autenticación</h3>
                <p style="margin-bottom: 15px;">Esto demuestra que la seguridad funciona correctamente.</p>
                
                <button class="btn" onclick="tryWithoutToken()" style="background: linear-gradient(135deg, #f6ad55 0%, #ed8936 100%);">
                    ⚠️ Intentar Crear Producto SIN Token
                </button>
                
                <div id="unauthorized-response" style="display: none; margin-top: 15px;"></div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="grid">
                ...
                <div class="step">
                    <h3>🔒 HTTPS (Semana 9)</h3>
                    <ul style="margin-left: 20px; margin-top: 10px;">
                        <li>✅ TLS 1.2/1.3</li>
                        <li>✅ Puerto 8443</li>
                        <li>✅ Certificados RSA 4096</li>
                        <li>✅ Redirección HTTP→HTTPS</li>
                    </ul>
                </div>
                
                <div class="step">
                    <h3>🔑 Secretos (Semana 9)</h3>
                    <ul style="margin-left: 20px; margin-top: 10px;">
                        <li>✅ pydantic-settings</li>
                        <li>✅ .env gitignored</li>
                        <li>✅ Validación automática</li>
                        <li>✅ Sin hardcode</li>
                    </ul>
                </div>
    ...
    <script>
        ...
        // Detectar HTTPS
        window.addEventListener('DOMContentLoaded', function() {{
            const indicator = document.getElementById('https-indicator');
            const isSecure = window.location.protocol === 'https:';
            ...
            if (!isSecure) {{
                ...
                indicator.innerHTML = `
                    ...
                    <div>
                        <div>Conexión HTTP (Insegura)</div>
                        <div style="font-size: 0.9em; opacity: 0.9;">Cambia a https://localhost:8443</div>
                    </div>
                `;
            }}
        }});
        ...
        async function login() {{
            ...
            try {{
                ...
                if (response.ok) {{
                    ...
                    createBtn.textContent = '✅ Crear Producto (Token Cargado)';
                }} else {{
                    alert('❌ Error en login: ' + data.detail);
                }}
            }} catch (error) {{
        ...
        async function createProduct() {{
            ...
            try {{
                ...
                createResponse.innerHTML = `
                    <div class="status status-${{response.ok ? 'success' : 'error'}}">
                ...
                createResponse.innerHTML = `
                    ...
                    <div class="response-display">${{error.message}}</div>
                `;
                createResponse.style.display = 'block';
            }}
        }}
        
        // Función para probar sin token
        async function tryWithoutToken() {{
            const unauthorizedResponse = document.getElementById('unauthorized-response');
            ...
            try {{
                ...
                unauthorizedResponse.innerHTML = `
                    <div class="status status-error">❌ ${{response.status}} Unauthorized</div>
                    <div class="response-display">${{JSON.stringify(data, null, 2)}}</div>
                    <div class="info-box" style="margin-top: 15px;">
                        <h4>✅ ¡La seguridad funciona!</h4>
                        <p>El servidor rechazó la petición porque no había token JWT válido.</p>
                    </div>
                `;
                unauthorizedResponse.style.display = 'block';
            }} catch (error) {{
                unauthorizedResponse.innerHTML = `
                    <div class="status status-error">❌ Error</div>
                    <div class="response-display">${{error.message}}</div>
